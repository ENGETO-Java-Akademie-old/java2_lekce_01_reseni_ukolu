    ...
    public boolean removeValue(int value) {
        if (this.value > value) {
            if (leftChild == null) {
                ...
                return leftChild.removeValue(value);
            }
        } else if (this.value < value) {
            if (rightChild == null) {
                return false;
            } else if (rightChild.value == value && rightChild.getNumberOfChildNodes() == 0) {
                rightChild = null;
            } else {
            ...
            if (leftChild == null && rightChild != null) {
                ...
                throw new UnsupportedOperationException("Node cannot delete itself");
            }
        }
        return false;
    }
